...
DJOSER = {
    'SERIALIZERS': {
        'user_create': 'core.serializers.CustomUserCreateSerializer',  # Custom registration serializer
        'user': 'core.serializers.CustomUserProfileSerializer',  # Custom profile serializer
